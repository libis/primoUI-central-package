  ...
  _createClass(AfterComponents, null, [{
    ...
    get: function get() {
      ...
      */
      ...
      { name: 'search-also', config: _searchAlso.searchAlsoConfig, enabled: true, appendTo: 'prm-facet-after', enableInView: '^KULeuven|^VIVES|^ODISEE|^FARO|^TMOREK|^TMOREMA' }, { name: 'search-also-body', config: _searchAlsoBody.searchAlsoBodyConfig, enabled: true, appendTo: 'prm-facet-exact-after', enableInView: '^KULeuven|^VIVES|^ODISEE|^FARO' }, { name: 'search-also-body-bib', config: _searchAlsoBodyBib.searchAlsoBodyBibConfig, enabled: true, appendTo: 'prm-facet-exact-after', enableInView: '^VIVES|^ODISEE|^FARO|^TMOREK|^TMOREMA' }, { name: 'search-also-body-google', config: _searchAlsoBodyGoogle.searchAlsoBodyGoogleConfig, enabled: true, appendTo: 'prm-facet-exact-after', enableInView: '^ODISEE|^FARO|^TMOREK|^TMOREMA' }, { name: 'search-also-body-worldcat', config: _searchAlsoBodyWorldcat.searchAlsoBodyWorldcatConfig, enabled: true, appendTo: 'prm-facet-exact-after', enableInView: '^KULeuven' }, { name: 'browzine', config: _browzine.browzineConfig, enabled: true, appendTo: 'prm-search-result-availability-line-after', enableInView: '^KULeuven|^ECB' }, { name: 'search-collections', config: _exploreSearchCollections.searchCollectionsConfig, enabled: true, appendTo: 'prm-collection-gallery-header-after', enableInView: '^KULeuven' }].filter(function (component) {
...
},{"./components/general/ConfigLanguageSelection":2,"./components/general/databaseLink":3,"./components/general/disclaimer":5,"./components/general/experiment":6,"./components/general/exposeJwt":7,"./components/general/removeAlerts":8,"./components/general/removeCheckLocations":9,"./components/general/searchTip":10,"./components/general/staticFooter":11,"./components/prmAutoPromoteLogin/autoPromoteLogin":12,"./components/prmBriefResultAfter/altmetric":13,"./components/prmBriefResultAfter/sourceIcon":14,"./components/prmCollectionGalleryHeaderAfter/exploreSearchCollections":15,"./components/prmFacetAfter/searchAlso":16,"./components/prmFacetExactAfter/searchAlsoBody":17,"./components/prmFacetExactAfter/searchAlsoBodyBib":18,"./components/prmFacetExactAfter/searchAlsoBodyGoogle":19,"./components/prmFacetExactAfter/searchAlsoBodyWorldcat":20,"./components/prmFinesOverviewAfter/payMyFines":21,"./components/prmFullViewAfter/altmetricsBadge":22,"./components/prmLogoAfter/betaSwitch":23,"./components/prmLogoAfter/homeIcon":24,"./components/prmLogoAfter/languageDependentLogo":25,"./components/prmLogoAfter/newSearchButton":26,"./components/prmLogoAfter/viewLogo":27,"./components/prmMainMenuAfter/feedback":28,"./components/prmRecommendationItemAfter/recommendationItem":29,"./components/prmRequestsAfter/illRequestForm":30,"./components/prmSearchResultAvailabilityLineAfterController/browzine":31,"./components/prmSearchResultThumbnailContainerAfter/pnxXml":32,"./components/prmServiceHeaderAfter/reportAProblem":33,"./components/prmServiceHeaderAfter/requestACopy":34,"./components/prmServiceHeaderAfter/requestACopyOfEsDoc":35,"./components/prmTopBarBefore/announcements":36,"./components/prmTopBarBefore/feedbackAnnouncement":37,"./components/prmTopBarBefore/finesMessage":39,"./utils":58}],2:[function(require,module,exports){
'use strict';
...
},{"./feedbackAnnouncementDialog":38}],38:[function(require,module,exports){
'use strict';
...
},{"../components/general/dialog":4}],45:[function(require,module,exports){
'use strict';
...
},{"./components":1,"./factories/altmetricsService":40,"./factories/apiCallInterceptor":41,"./factories/dbSearchHttpCallInterceptor":42,"./factories/feedService":43,"./factories/feedbackService":44,"./factories/messageService":45,"./factories/windowEventListener":46,"./primo-explore-dom/js/primo":48,"./primo-explore-dom/js/primo/explore/helper":51,"./templates":57}],48:[function(require,module,exports){
'use strict';
...
},{"./primo/explore":49,"./primo/explore/helper":51,"./primo/facets":52,"./primo/records":53,"./primo/user":54,"./primo/view":55}],49:[function(require,module,exports){
'use strict';
...
},{"./explore/components":50,"./explore/helper":51}],50:[function(require,module,exports){
'use strict';
...
},{"../../vendor/css-selector-generator.js":56,"./helper":51}],51:[function(require,module,exports){
'use strict';
...
},{"./explore/components":50,"./explore/helper":51}],53:[function(require,module,exports){
'use strict';
...
},{"./explore/components":50,"./explore/helper":51}],54:[function(require,module,exports){
'use strict';
...
},{"./explore/helper":51}],55:[function(require,module,exports){
'use strict';
...
},{"./explore/helper":51}],56:[function(require,module,exports){
'use strict';
